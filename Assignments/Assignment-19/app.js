// DOM Assignment # 58-67JAVASCRIPT
...
//  // iv. Fill input value whose element id is "first-name" using JavaScript.
 var firstNameInput = document.getElementById("first-name").value = "Rida"



//  // v. Repeat part iv for id "last-name" and "email".

var lastNameInput = document.getElementById("last-name").value = "Azam";
var emailInput = document.getElementById("email").value = "rida@gmail.com";
